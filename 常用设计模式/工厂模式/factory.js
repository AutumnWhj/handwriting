...
var Car110Factory = /** @class */ (function (_super) {
    __extends(Car110Factory, _super);
    function Car110Factory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Car110Factory.prototype.buildeCar = function () {
        return new Car110();
    };
    return Car110Factory;
}(CarFactory));
var Car119Factory = /** @class */ (function (_super) {
    __extends(Car119Factory, _super);
    function Car119Factory() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Car119Factory.prototype.buildeCar = function () {
        return new Car119();
    };
    return Car119Factory;
}(CarFactory));
var car110 = new Car110Factory().buildeCar();
var car119 = new Car119Factory().buildeCar();
car110.run();
car119.run();
//场景
